...
- [x] Commit changes
  - Commits: ea38dfa2, 1ca6b1bf on branch users/dwebb/fix-timestamp-serialization
- [x] Push to branch
  - Pushed to origin/users/dwebb/fix-timestamp-serialization
- [x] Create PR
  - PR #2: https://github.com/denniswebb/terrakube/pull/2
  - Note: Initially created PR #2819 on upstream by mistake, closed it and created proper PR in fork
